...
<div class="main-wrapper" style="margin-top: -5ch">
  <!-- Breadscrumb Section -->
      ...
      <div class="row align-items-center">
        <div class="col-lg-6" data-aos="fade-down">
          <div class="about-img">
            ...
            <div class="abt-img">
              <img
                src="<?= $asset->baseUrl ?>/img/about-us.png"
                class="img-fluid"
                alt="About us"
              />
            </div>
  ...
  <section class="section services bg-light-primary">
    <div class="service-right">
      <img
        src="<?= $asset->baseUrl ?>/img/bg/service-right.svg"
        class="img-fluid"
        alt="services right"
      />
    </div>
            ...
            <div class="services-group">
              <div class="services-icon border-secondary">
                <img
                  ...
                  src="<?= $asset->baseUrl ?>/img/icons/services-icon-01.svg"
  ...
  <section class="section facts-number">
    <div class="facts-left">
      <img
        src="<?= $asset->baseUrl ?>/img/bg/facts-left.png"
        class="img-fluid"
        alt="facts left"
      />
    </div>
    <div class="facts-right">
      <img
        src="<?= $asset->baseUrl ?>/img/bg/facts-right.png"
        class="img-fluid"
        alt="facts right"
      />
    </div>
          ...
          <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down">
            <div class="count-group flex-fill">
              <div class="customer-count d-flex align-items-center">
                <div class="count-img">
                  <img
                    src="<?= $asset->baseUrl ?>/img/icons/bx-heart.svg"
                    alt=""
                  />
                </div>
          ...
          <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down">
            <div class="count-group flex-fill">
              <div class="customer-count d-flex align-items-center">
                <div class="count-img">
                  <img
                    src="<?= $asset->baseUrl ?>/img/icons/bx-car.svg"
                    alt=""
                  />
                </div>
                <div class="count-content">
          ...
          <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down">
            <div class="count-group flex-fill">
              <div class="customer-count d-flex align-items-center">
                <div class="count-img">
                  <img
                    src="<?= $asset->baseUrl ?>/img/icons/bx-headphone.svg"
                    alt=""
                  />
                </div>
                <div class="count-content">
          ...
          <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down">
            <div class="count-group flex-fill">
              <div class="customer-count d-flex align-items-center">
                <div class="count-img">
                  <img
                    src="<?= $asset->baseUrl ?>/img/icons/bx-history.svg"
                    alt=""
                  />
                </div>
                <div class="count-content">
  ...
  <section class="section why-choose">
    <div class="choose-left">
      <img
        src="<?= $asset->baseUrl ?>/img/bg/choose-left.png"
        class="img-fluid"
        alt="Why Choose Us"
      />
    </div>
            ...
            <div class="card flex-fill">
              <div class="card-body">
                <div class="choose-img choose-black">
                  <img
                    src="<?= $asset->baseUrl ?>/img/icons/bx-user-check.svg"
                    alt=""
                  />
                </div>
