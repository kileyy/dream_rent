		...
		<div class="tab-content" id="pills-tabContent">
			<div class="tab-pane fade show active" id="pills-booking" role="tabpanel" aria-labelledby="pills-booking-tab">
				...
				<div class="back-detail-page">
					<a href="/listing/listing-details"><i class="fa-solid fa-arrow-left me-2"></i> Back to detail page</a>
				</div>
			</div>
			<div class="tab-pane fade" id="pills-payment" role="tabpanel" aria-labelledby="pills-payment-tab">
				<div class="booking-details payment-details">
					...
					<div class="payment-method">
						...
						<ul>
							<li><a href=""><img src="<?= $asset->baseUrl ?>/img/icons/payment-1.svg" alt=""></a></li>
							<li><a href=""><img src="<?= $asset->baseUrl ?>/img/icons/payment-2.svg" alt=""></a></li>
							<li><a href=""><img src="<?= $asset->baseUrl ?>/img/icons/payment-3.svg" alt=""></a></li>
							<li><a href=""><img src="<?= $asset->baseUrl ?>/img/icons/payment-4.svg" alt=""></a></li>
						</ul>
						<div class="booking-form">
							<div class="booking-title">
								<h5>Enter Below details</h5>
				...
				<div class="back-detail-page">
					<a href="/pages/booking"><i class="fa-solid fa-arrow-left me-2"></i> Back to Booking Detail</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-body">
				<div class="payment-success">
					...
					<div class="order-confirm">
						<a href="/pages/booking">Go to Order Confirmation<i class="fa-solid fa-arrow-right ms-2"></i></a>
					</div>
				</div>
