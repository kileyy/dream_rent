        ...
        <div class="col-xl-8 col-lg-9 col-sm-12 col-12">
          <div class="product-filter-group">
            ...
            <div class="grid-listview">
              <ul>
                <li>
                  <a href="/listing/listing-grid" class="active">
                    <i class="feather-grid"></i>
                  </a>
                </li>
                <li>
                  <a href="/listing/listing-list">
        ...
        <form action="#" autocomplete="off" class="sidebar-form">
          ...
          <div class="product-search">
            <div class="form-custom">
              ...
              <span><img src="<?= $asset->baseUrl ?>/img/icons/search.svg" alt="img"></span>
            </div>
          </div>
        ...
        <div class="row">
              ...
              <div class="listing-content">
                <div class="listing-features">
                  ...
                  <h3 class="listing-title">
                    <a href="/listing/listing-details">Toyota Camry SE 350</a>
                  </h3>
                ...
                <div class="listing-details-group">
                  <ul>
                    <li>
                      <span><img src="<?= $asset->baseUrl ?>/img/icons/car-parts-05.svg" alt="Auto"></span>
                      <p>Auto</p>
                    </li>
                    <li>
                ...
                <div class="listing-button">
                  <a href="/listing/listing-details" class="btn btn-order"><span><i class="feather-calendar me-2"></i></span>Rent Now</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="listing-item">
              ...
              <div class="listing-content">
                <div class="listing-features">
                  ...
                  <h3 class="listing-title">
                    <a href="/listing/listing-details">Kia Soul 2016</a>
                  </h3>
                  <div class="list-rating">
                    <i class="fas fa-star filled"></i>
                    <i class="fas fa-star filled"></i>
            ...
            <div class="listing-item">
              ...
              <div class="listing-content">
                <div class="listing-features">
                  ...
                  <h3 class="listing-title">
                    <a href="/listing/listing-details">Audi A3 2019 new</a>
                  </h3>
                  <div class="list-rating">
                    <i class="fas fa-star filled"></i>
                    <i class="fas fa-star filled"></i>
            ...
            <div class="listing-item">
              ...
              <div class="listing-content">
                <div class="listing-features">
                  ...
                  <h3 class="listing-title">
                    <a href="/listing/listing-details">Ferrari 458 MM Speciale</a>
                  </h3>
                  <div class="list-rating">
                    <i class="fas fa-star filled"></i>
                    <i class="fas fa-star filled"></i>
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="listing-item">
              <div class="listing-img">
                <a href="/listing/listing-details">
                  <img src="<?= $asset->baseUrl ?>/img/cars/car-05.jpg" class="img-fluid" alt="Audi">
                </a>
                <div class="fav-item">
              ...
              <div class="listing-content">
                <div class="listing-features">
                  <a href="javascript:void(0)" class="author-img">
                    <img src="<?= $asset->baseUrl ?>/img/profiles/avatar-05.jpg" alt="author">
                  </a>
                  <h3 class="listing-title">
                    <a href="/listing/listing-details">2018 Chevrolet Camaro</a>
                  </h3>
                  <div class="list-rating">
                    <i class="fas fa-star filled"></i>
                    <i class="fas fa-star filled"></i>
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="listing-item">
              <div class="listing-img">
                <a href="/listing/listing-details">
                  <img src="<?= $asset->baseUrl ?>/img/cars/car-06.jpg" class="img-fluid" alt="Audi">
                </a>
                <div class="fav-item">
              ...
              <div class="listing-content">
                <div class="listing-features">
                  <a href="javascript:void(0)" class="author-img">
                    <img src="<?= $asset->baseUrl ?>/img/profiles/avatar-06.jpg" alt="author">
                  </a>
                  <h3 class="listing-title">
                    <a href="/listing/listing-details">Acura Sport Version</a>
                  </h3>
                  <div class="list-rating">
                    <i class="fas fa-star filled"></i>
                    <i class="fas fa-star filled"></i>
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="listing-item">
              <div class="listing-img">
                <a href="/listing/listing-details">
                  <img src="<?= $asset->baseUrl ?>/img/cars/car-07.jpg" class="img-fluid" alt="Audi">
                </a>
                <div class="fav-item">
                  <span class="featured-text">Chevrolet</span>
                  <a href="javascript:void(0)" class="fav-icon">
              ...
              <div class="listing-content">
                <div class="listing-features">
                  <a href="javascript:void(0)" class="author-img">
                    <img src="<?= $asset->baseUrl ?>/img/profiles/avatar-07.jpg" alt="author">
                  </a>
                  <h3 class="listing-title">
                    <a href="/listing/listing-details">Chevrolet Pick Truck 3.5L</a>
                  </h3>
                  <div class="list-rating">
                    <i class="fas fa-star filled"></i>
                    <i class="fas fa-star filled"></i>
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="listing-item">
              <div class="listing-img">
                <a href="/listing/listing-details">
                  <img src="<?= $asset->baseUrl ?>/img/cars/car-08.jpg" class="img-fluid" alt="Toyota">
                </a>
                <div class="fav-item">
                  <span class="featured-text">Toyota</span>
                  <a href="javascript:void(0)" class="fav-icon">
              ...
              <div class="listing-content">
                <div class="listing-features">
                  <a href="javascript:void(0)" class="author-img">
                    <img src="<?= $asset->baseUrl ?>/img/profiles/avatar-08.jpg" alt="author">
                  </a>
                  <h3 class="listing-title">
                    <a href="/listing/listing-details">Toyota Tacoma 4WD</a>
                  </h3>
                  <div class="list-rating">
                    <i class="fas fa-star filled"></i>
                    <i class="fas fa-star filled"></i>
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="listing-item">
              <div class="listing-img">
                <a href="/listing/listing-details">
                  <img src="<?= $asset->baseUrl ?>/img/cars/car-09.jpg" class="img-fluid" alt="Toyota">
                </a>
                <div class="fav-item">
              ...
              <div class="listing-content">
                <div class="listing-features">
                  ...
                  <h3 class="listing-title">
                    <a href="/listing/listing-details">Acura RDX FWD</a>
                  </h3>
                  <div class="list-rating">
                    <i class="fas fa-star filled"></i>
                    <i class="fas fa-star filled"></i>
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="listing-item">
              <div class="listing-img">
                <a href="/listing/listing-details">
                  <img src="<?= $asset->baseUrl ?>/img/cars/car-02.jpg" class="img-fluid" alt="Toyota">
                </a>
                <div class="fav-item">
