				...
				<div class="col-xl-8 col-lg-9 col-sm-12 col-12">
					<div class="product-filter-group">
						...
						<div class="grid-listview">
							<ul>
								<li>
									<a href="/listing/listing-grid">
										<i class="feather-grid"></i>
									</a>
								</li>
								<li>
									<a href="/listing/listing-list" class="active">
							...
							<div class="blog-widget d-flex">
								<div class="blog-img">
									<a href="/listing/listing-details">
										<img src="<?= $asset->baseUrl ?>/img/car-list-1.jpg" class="img-fluid" alt="blog-img">
									</a>
								</div>
									...
									<div class="card-body">
										<div class="blog-list-head d-flex">
											<div class="blog-list-title">
												<h3><a href="/listing/listing-details">Ferrari 458 MM Speciale</a></h3>
										...
										<div class="blog-list-head list-head-bottom d-flex">
											<div class="blog-list-title">
												<div class="title-bottom">
													<div class="car-list-icon">
														<img src="<?= $asset->baseUrl ?>/img/cars/car-list-icon-01.png" alt="">
													</div>
											...
											<div class="listing-button">
												<a href="/listing/listing-details" type="sumit" class="btn btn-order"><span><i class="feather-calendar me-2"></i></span>Rent Now</a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="listview-car">
						<div class="card">
							<div class="blog-widget d-flex">
								<div class="blog-img">
									<a href="/listing/listing-details">
										<img src="<?= $asset->baseUrl ?>/img/car-list-2.jpg" class="img-fluid" alt="blog-img">
									</a>
								</div>
								<div class="bloglist-content w-100">
									<div class="card-body">
										...
										<div class="blog-list-head list-head-bottom d-flex">
											<div class="blog-list-title">
												<div class="title-bottom">
													<div class="car-list-icon">
														<img src="<?= $asset->baseUrl ?>/img/cars/car-list-icon-02.png" alt="">
													</div>
													<div class="address-info">
														<h5><a href="">Toyota Of Lincoln Park</a></h5>
														<h6><i class="feather-map-pin me-2"></i>Newyork, USA</h6>
					...
					<div class="listview-car">
						<div class="card">
							<div class="blog-widget d-flex">
								<div class="blog-img">
									<a href="/listing/listing-details">
										<img src="<?= $asset->baseUrl ?>/img/car-list-3.jpg" class="img-fluid" alt="blog-img">
									</a>
								</div>
								<div class="bloglist-content w-100">
									<div class="card-body">
										...
										<div class="blog-list-head list-head-bottom d-flex">
											<div class="blog-list-title">
												<div class="title-bottom">
													<div class="car-list-icon">
														<img src="<?= $asset->baseUrl ?>/img/cars/car-list-icon-03.png" alt="">
													</div>
													<div class="address-info">
														<h5><a href="">Toyota Of Lincoln Park</a></h5>
														<h6><i class="feather-map-pin me-2"></i>Newyork, USA</h6>
