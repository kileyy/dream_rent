  ...
  <div class="container">
    <div class="detail-page-head">
      ...
      <div class="details-btn">
        <a href="">
          <img src="<?= $asset->baseUrl ?>/img/git-compare.svg" alt="" />
          Compare</a
        >
        ...
        <div class="detail-product">
          <div class="slider detail-bigimg">
            <div class="product-img">
              <img
                src="<?= $asset->baseUrl ?>/img/cars/slider-01.jpg"
                alt="Slider"
              />
            </div>
            <div class="product-img">
              <img
                src="<?= $asset->baseUrl ?>/img/cars/slider-02.jpg"
                alt="Slider"
              />
            </div>
            <div class="product-img">
              <img
                src="<?= $asset->baseUrl ?>/img/cars/slider-03.jpg"
                alt="Slider"
              />
            </div>
            <div class="product-img">
              <img
                src="<?= $asset->baseUrl ?>/img/cars/slider-04.jpg"
                alt="Slider"
              />
            </div>
            <div class="product-img">
              <img
                src="<?= $asset->baseUrl ?>/img/cars/slider-05.jpg"
                alt="Slider"
              />
            </div>
          </div>
          <div class="slider slider-nav-thumbnails">
            <div>
              <img
                src="<?= $asset->baseUrl ?>/img/cars/slider-thum-01.jpg"
                alt="product image"
              />
            </div>
            <div>
              <img
                src="<?= $asset->baseUrl ?>/img/cars/slider-thum-02.jpg"
                alt="product image"
              />
            </div>
            <div>
              <img
                src="<?= $asset->baseUrl ?>/img/cars/slider-thum-03.jpg"
                alt="product image"
              />
            </div>
            <div>
              <img
                src="<?= $asset->baseUrl ?>/img/cars/slider-thum-04.jpg"
                alt="product image"
              />
            </div>
            <div>
              <img
                src="<?= $asset->baseUrl ?>/img/cars/slider-thum-05.jpg"
                alt="product image"
              />
            </div>
          </div>
              ...
              <div class="row">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-1.svg"
                      alt=""
                    />
                  </div>
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-2.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-3.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-4.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-5.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-6.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-7.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-8.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-9.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-10.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-11.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
                ...
                >
                  <div class="feature-img">
                    <img
                      src="<?= $asset->baseUrl ?>/img/specification/specification-icon-12.svg"
                      alt=""
                    />
                  </div>
                  <div class="featues-info">
            ...
            <div class="row">
              <div class="col-md-4">
                <ul>
                  ...
                  <li>
                    <span><i class="fa-solid fa-check-double"></i></span>Heated
                    front seats
                  </li>
                  <li>
                    <span><i class="fa-solid fa-check-double"></i></span>Andriod
                    Auto
                  </li>
                  <li>
                    <span><i class="fa-solid fa-check-double"></i></span
              ...
              <div class="col-md-4">
                <ul>
                  <li>
                    <span><i class="fa-solid fa-check-double"></i></span>Premium
                    sound system
                  </li>
                  <li>
                    <span><i class="fa-solid fa-check-double"></i></span
                  ...
                  <li>
                    <span><i class="fa-solid fa-check-double"></i></span>Keyles
                    Start
                  </li>
                  <li>
                    <span><i class="fa-solid fa-check-double"></i></span>Memory
                    seat
                  </li>
                </ul>
              </div>
              <div class="col-md-4">
                <ul>
                  ...
                  <li>
                    <span><i class="fa-solid fa-check-double"></i></span>4 power
                    windows
                  </li>
                </ul>
              </div>
            ...
            <div class="review-header-group">
              <div class="review-widget-header">
                <span class="review-widget-img">
                  <img
                    src="<?= $asset->baseUrl ?>/img/profiles/avatar-01.jpg"
                    class="img-fluid"
                    alt=""
                  />
                </span>
          ...
          <div class="review-card">
            <div class="review-header-group">
              <div class="review-widget-header">
                <span class="review-widget-img">
                  <img
                    src="<?= $asset->baseUrl ?>/img/profiles/avatar-02.jpg"
                    class="img-fluid"
                    alt=""
                  />
                </span>
        ...
        <div class="review-sec extra-service mt-0">
          ...
          <div class="owner-detail">
            <div class="owner-img">
              <a href=""
                ><img
                  src="<?= $asset->baseUrl ?>/img/profiles/avatar-07.jpg"
                  alt=""
              /></a>
            </div>
            <div class="reviewbox-list-rating">
            ...
            <div class="card">
              <div class="listing-item pb-0">
                <div class="listing-img">
                  <a href="/listing/listing-details">
                    <img
                      src="<?= $asset->baseUrl ?>/img/cars/car-02.jpg"
                      class="img-fluid"
                      alt="KIA"
                    />
                  </a>
                ...
                <div class="listing-content">
                  ...
                  <div class="listing-details-group">
                    <ul>
                      <li>
                        <span
                          ><img
                            src="<?= $asset->baseUrl ?>/img/icons/car-parts-05.svg"
                            alt="Auto"
                        /></span>
                        <p>Auto</p>
                      </li>
                      <li>
                        <span
                          ><img
                            src="<?= $asset->baseUrl ?>/img/icons/car-parts-02.svg"
                            alt="22 KM"
                        /></span>
                        <p>22 KM</p>
                      </li>
                      <li>
                        <span
                          ><img
                            src="<?= $asset->baseUrl ?>/img/icons/car-parts-03.svg"
                            alt="Petrol"
                        /></span>
                        <p>Petrol</p>
                      </li>
                    ...
                    <ul>
                      <li>
                        <span
                          ><img
                            src="<?= $asset->baseUrl ?>/img/icons/car-parts-04.svg"
                            alt="Diesel"
                        /></span>
                        <p>Diesel</p>
                      </li>
                      ...
                      <li>
                        <span
                          ><img
                            src="<?= $asset->baseUrl ?>/img/icons/car-parts-06.svg"
                            alt="Persons"
                        /></span>
                        <p>5 Persons</p>
                      </li>
                  ...
                  <div class="listing-button">
                    <a href="/listing/listing-details" class="btn btn-order"
            ...
            <div class="card">
              <div class="listing-item pb-0">
                <div class="listing-img">
                  <a href="/listing/listing-details">
                    <img
                      src="<?= $asset->baseUrl ?>/img/cars/car-07.jpg"
                      class="img-fluid"
                      alt="Audi"
                    />
                  </a>
            ...
            <div class="card">
              <div class="listing-item pb-0">
                <div class="listing-img">
                  <a href="/listing/listing-details">
                    <img
                      src="<?= $asset->baseUrl ?>/img/cars/car-03.jpg"
                      class="img-fluid"
                      alt="Audi"
                    />
                  </a>
                ...
                <div class="listing-content">
                  <div class="listing-features">
                    <div class="author-img">
                      <img
                        src="<?= $asset->baseUrl ?>/img/profiles/avatar-03.jpg"
                        alt="author"
                      />
                    </div>
                    <h3 class="listing-title">
            ...
            <div class="card">
              <div class="listing-item pb-0">
                <div class="listing-img">
                  <a href="/listing/listing-details">
                    <img
                      src="<?= $asset->baseUrl ?>/img/cars/car-04.jpg"
                      class="img-fluid"
                      alt="Audi"
                    />
                  </a>
                ...
                <div class="listing-content">
                  <div class="listing-features">
                    <div class="author-img">
                      <img
                        src="<?= $asset->baseUrl ?>/img/profiles/avatar-04.jpg"
                        alt="author"
                      />
                    </div>
                    <h3 class="listing-title">
            ...
            <div class="card">
              <div class="listing-item pb-0">
                <div class="listing-img">
                  <a href="/listing/listing-details">
                    <img
                      src="<?= $asset->baseUrl ?>/img/cars/car-05.jpg"
                      class="img-fluid"
                      alt="Audi"
                    />
                  </a>
                ...
                <div class="listing-content">
                  <div class="listing-features">
                    <div class="author-img">
                      <img
                        src="<?= $asset->baseUrl ?>/img/profiles/avatar-05.jpg"
                        alt="author"
                      />
                    </div>
                    <h3 class="listing-title">
            ...
            <div class="card">
              <div class="listing-item pb-0">
                <div class="listing-img">
                  <a href="/listing/listing-details">
                    <img
                      src="<?= $asset->baseUrl ?>/img/cars/car-06.jpg"
                      class="img-fluid"
                      alt="Audi"
                    />
                  </a>
                ...
                <div class="listing-content">
                  <div class="listing-features">
                    <div class="author-img">
                      <img
                        src="<?= $asset->baseUrl ?>/img/profiles/avatar-06.jpg"
                        alt="author"
                      />
                    </div>
                    <h3 class="listing-title">
              ...
              <div class="listing-item pb-0">
                ...
                <div class="listing-content">
                  ...
                  <div class="listing-location-details">
                    ...
                    <!-- Datepicker Core JS -->
                    <script src="<?= $asset->baseUrl ?>/plugins/moment/moment.min.js"></script>
                    <script src="<?= $asset->baseUrl ?>/js/bootstrap-datetimepicker.min.js"></script>

                    <!-- Slick JS -->
                    <script src="<?= $asset->baseUrl ?>/plugins/slick/slick.js"></script>

                    <!-- Owl Carousel JS -->
                    <script src="<?= $asset->baseUrl ?>/js/owl.carousel.min.js"></script>

                    <!-- Top JS -->
                    <script src="<?= $asset->baseUrl ?>/js/backToTop.js"></script>

                    <!-- Sticky Sidebar JS -->
                    <script src="<?= $asset->baseUrl ?>/plugins/theia-sticky-sidebar/ResizeSensor.js"></script>
                    <script src="<?= $asset->baseUrl ?>/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js"></script>
  ...
  <div class="modal-dialog modal-dialog-centered modal-md">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="/pages/booking" class="btn btn-back"
