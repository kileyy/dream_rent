      ...
      <li>
        <div class="post-author">
          <div class="post-author-img">
            <img src="<?= $asset->baseUrl ?>/img/profiles/avatar-01.jpg" alt="author" />
          </div>
...
<div class="blog-section">
  <div class="container">
    ...
    <blockquote class="blog-quotes">
      <img src="<?= $asset->baseUrl ?>/img/blogquote.svg" alt="quotes" />
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
        vehicula sapien nec nisi aliquam, vitae finibus purus sodales. Mauris at
        turpis nulla. Curabitur nec tellus est. Class aptent taciti sociosqu ad
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="bloginner-img">
          <img src="<?= $asset->baseUrl ?>/img/blog/blog-detail-01.jpg" class="img-fluid" alt="" />
        </div>
      </div>
      <div class="col-lg-6 col-md-6">
        <div class="bloginner-img">
          <img src="<?= $asset->baseUrl ?>/img/blog/blog-detail-02.jpg" class="img-fluid" alt="" />
        </div>
      </div>
    </div>
    ...
    <div class="blogdetails-pagination">
      <ul>
        <li>
          <a href="/blog/blog-details" class="prev-link"><i class="fas fa-regular fa-arrow-left"></i> Previous Post</a>
          <a href="/blog/blog-details">
            <h3>The Best SPA Salons For Your Relaxation</h3>
          </a>
        </li>
        <li>
          <a href="/blog/blog-details" class="next-link">Next Post <i class="fas fa-regular fa-arrow-right"></i>
          </a>
          <a href="/blog/blog-details">
    ...
    <div class="review-sec mb-0">
        ...
        <div class="review-header-group">
          <div class="review-widget-header">
            <span class="review-widget-img">
              <img src="<?= $asset->baseUrl ?>/img/profiles/avatar-01.jpg" class="img-fluid" alt="" />
            </span>
      ...
      <div class="review-card">
        <div class="review-header-group">
          <div class="review-widget-header">
            <span class="review-widget-img">
              <img src="<?= $asset->baseUrl ?>/img/profiles/avatar-02.jpg" class="img-fluid" alt="" />
            </span>
            <div class="review-design">
              <h6>Casandra</h6>
              <p>02 Jan 2023</p>
