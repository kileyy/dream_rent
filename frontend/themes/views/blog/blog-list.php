			...
			<div class="col-lg-8">
				<div class="row">
					<div class="col-lg-12 col-md-12 d-lg-flex">
						<div class="blog grid-blog">
							<div class="blog-image-list">
								<a href="/blog/blog-details"><img class="img-fluid" src="<?= $asset->baseUrl ?>//img/blog/blog-list-01.jpg" alt="Post Image"></a>
							</div>
							<div class="blog-content">
								...
								<a href="/blog/blog-details" class="viewlink btn btn-primary justify-content-center">Read More <i class="feather-arrow-right ms-2"></i></a>
							</div>
						</div>
					</div>
					<div class="col-lg-12 col-md-12 d-lg-flex">
						<div class="blog grid-blog">
							<div class="blog-image-list">
								<a href="/blog/blog-details"><img class="img-fluid" src="<?= $asset->baseUrl ?>//img/blog/blog-list-02.jpg" alt="Post Image"></a>
							</div>
							<div class="blog-content">
								<div class="blog-list-date">
									<ul class="meta-item-list">
					...
					<div class="col-lg-12 col-md-12 d-lg-flex">
						<div class="blog grid-blog">
							<div class="blog-image-list">
								<a href="/blog/blog-details"><img class="img-fluid" src="<?= $asset->baseUrl ?>//img/blog/blog-list-03.jpg" alt="Post Image"></a>
							</div>
							<div class="blog-content">
								<div class="blog-list-date">
									<ul class="meta-item-list">
					...
					<div class="col-lg-12 col-md-12 d-lg-flex">
						<div class="blog grid-blog">
							<div class="blog-image-list">
								<a href="/blog/blog-details"><img class="img-fluid" src="<?= $asset->baseUrl ?>//img/blog/blog-list-04.jpg" alt="Post Image"></a>
							</div>
							<div class="blog-content">
								<div class="blog-list-date">
									<ul class="meta-item-list">
