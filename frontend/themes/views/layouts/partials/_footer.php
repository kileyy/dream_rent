                    ...
                    <div class="col-md-6">
                        ...
                        <div class="copyright-menu">
                            <div class="vistors-details">
                                <ul class="d-flex">
                                    <li><a href="javascript:void(0)"><img class="img-fluid" src="<?= $asset->baseUrl ?>/img/icons/paypal.svg" alt="Paypal"></a></li>
                                    <li><a href="javascript:void(0)"><img class="img-fluid" src="<?= $asset->baseUrl ?>/img/icons/visa.svg" alt="Visa"></a></li>
                                    <li><a href="javascript:void(0)"><img class="img-fluid" src="<?= $asset->baseUrl ?>/img/icons/master.svg" alt="Master"></a></li>
                                    <li><a href="javascript:void(0)"><img class="img-fluid" src="<?= $asset->baseUrl ?>/img/icons/applegpay.svg" alt="applegpay"></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- /Copyright Menu -->
